(() => {
  ...
  frappe.ui.OnboardingTour = class OnboardingTour {
    ...
    get_step(step_info, on_next) {
      ...
      let element = (_a = cur_page == null ? void 0 : cur_page.page) == null ? void 0 : _a.querySelector(element_selector);
      ...
      if (element && (next_on_click || hide_buttons || modal_trigger)) {
        $(element).on("click", () => {
          var _a2, _b;
          if (!this.driver.getHighlightedElement() || ((_a2 = this.driver.getHighlightedElement().node.id) == null ? void 0 : _a2.startsWith("popover")))
            return;
          ...
          this.driver_steps = this.driver_steps.filter(
            (step) => {
              var _a3;
              return !((_a3 = step.element.id) == null ? void 0 : _a3.startsWith("popover"));
            }
          );
  ...
  frappe.ui.init_onboarding_tour = () => {
    ...
    const wait_for_data = setInterval(() => {
      if (!(cur_page == null ? void 0 : cur_page.page))
        return;
      if (cur_page.page.querySelector(".workspace-sidebar-skeleton"))
        return;
      if (cur_page.page.querySelector(".workspace-skeleton"))
        return;
...
//# sourceMappingURL=onboarding_tours.bundle.LXG2AWXU.js.map
