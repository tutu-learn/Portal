...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  // sfc-script:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/ui/user_onboarding/OnboardingPanel.vue?type=script
  var OnboardingPanel_default = {
    __name: "OnboardingPanel",
    props: {
      modelValue: {
        type: Boolean,
        default: true
    ...
    emits: ["update:modelValue", "skip"],
    setup(__props, { expose: __expose, emit: __emit }) {
      __expose();
      const props = __props;
      const emit = __emit;
      const collapsed = (0, vue_runtime_esm_bundler_exports.ref)(false);
      const visible = (0, vue_runtime_esm_bundler_exports.computed)({
        get: () => props.modelValue,
        set: (val) => emit("update:modelValue", val)
      });
      let skippAll = false;
      const completedCount = (0, vue_runtime_esm_bundler_exports.computed)(
        () => props.steps.filter((step) => step.is_complete || step.is_skipped).length
      );
      const progress = (0, vue_runtime_esm_bundler_exports.computed)(() => {
      ...
      function showFormTour(step) {
        let route = step.is_single ? frappe.router.slug(step.reference_document) : `${frappe.router.slug(step.reference_document)}/new`;
        frappe.route_hooks = {};
        frappe.route_hooks.after_load = (frm) => {
          const tour_name = step.form_tour;
          on_finish = () => markComplete(step);
          frm.tour.init({ tour_name, on_finish: () => markComplete(step) }).then(() => frm.tour.start());
        };
      ...
      const __returned__ = { props, emit, collapsed, visible, get skippAll() {
        return skippAll;
      }, set skippAll(v) {
        skippAll = v;
      }, completedCount, progress, close, toggleCollapse, skipAll, resetAll, handleAction, viewDocs, goToPage, openReport, showFormTour, updateSettings, createEntry, markComplete, markSkip, markReset, ref: vue_runtime_esm_bundler_exports.ref, computed: vue_runtime_esm_bundler_exports.computed };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/ui/user_onboarding/OnboardingPanel.vue?type=template
  var _hoisted_1 = {
    key: 0,
    class: "onb-panel"
  };
  var _hoisted_2 = { class: "header onb-header-main" };
  var _hoisted_3 = { class: "text-base font-medium" };
  var _hoisted_4 = { class: "onb-header-actions" };
  var _hoisted_5 = ["innerHTML"];
  var _hoisted_6 = ["innerHTML"];
  var _hoisted_7 = { class: "body" };
  var _hoisted_8 = { class: "onb-title" };
  var _hoisted_9 = ["innerHTML"];
  var _hoisted_10 = { class: "text-base font-medium" };
  var _hoisted_11 = { class: "onb-title-steps" };
  var _hoisted_12 = { class: "onb-progress-row" };
  var _hoisted_13 = { key: 0 };
  var _hoisted_14 = { class: "onb-progress-badge" };
  var _hoisted_15 = { key: 1 };
  var _hoisted_16 = { class: "onb-progress-badge-complete" };
  var _hoisted_17 = { key: 2 };
  var _hoisted_18 = { key: 3 };
  var _hoisted_19 = { class: "onb-steps flex flex-col gap-2.5 overflow-hidden" };
  ...
  var _hoisted_25 = { key: 2 };
  var _hoisted_26 = { key: 3 };
  var _hoisted_27 = {
  ...
  var _hoisted_30 = { class: "ml-auto onb-show-on-hover text-sm w-12 text-right" };
  var _hoisted_31 = ["onClick"];
  var _hoisted_32 = { key: 1 };
  var _hoisted_33 = { class: "ml-auto onb-show-on-hover text-sm w-12 text-right" };
  var _hoisted_34 = ["onClick"];
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return $setup.visible ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_1, [
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" Header "),
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_2, [
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_3, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Getting Started")), 1),
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_4, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", {
            onClick: $setup.toggleCollapse,
            innerHTML: $props.minimizeIcon
          }, null, 8, _hoisted_5),
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", {
            onClick: $setup.close,
            innerHTML: $props.closeIcon
          }, null, 8, _hoisted_6)
        ])
      ]),
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
        class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["onb-collapsible", $setup.collapsed ? "onb-collapsible--collapsed" : "onb-collapsible--expanded"])
      }, [
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_7, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_8, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
              class: "onb-title-icon",
              innerHTML: $props.headerIcon
            }, null, 8, _hoisted_9),
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_10, (0, vue_runtime_esm_bundler_exports.toDisplayString)($props.title), 1),
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_11, (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.completedCount) + "/" + (0, vue_runtime_esm_bundler_exports.toDisplayString)($props.steps.length) + " " + (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("steps completed")), 1)
          ]),
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_12, [
            $setup.progress !== 100 ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_13, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_14, (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.progress) + "% " + (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("completed")), 1)
            ])) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_15, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_16, (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.progress) + "% " + (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("completed")), 1)
            ])),
            $setup.skippAll ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_17, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                class: "onb-skip",
                onClick: _cache[0] || (_cache[0] = ($event) => $setup.resetAll($props.steps))
              }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Reset All")), 1)
            ])) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_18, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                class: "onb-skip",
                onClick: _cache[1] || (_cache[1] = ($event) => $setup.skipAll($props.steps))
              }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Skip All")), 1)
            ]))
          ]),
          (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" Steps "),
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_19, [
            ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($props.steps, (step, i) => {
              return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
                style: { "width": "100%" },
                key: i,
                class: (0, vue_runtime_esm_bundler_exports.normalizeClass)({ is_complete: step.is_complete })
              }, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
                  class: (0, vue_runtime_esm_bundler_exports.normalizeClass)([
                    "onb-group w-full step-title flex items-center",
                    step.is_complete ? "text-extra-muted onb-select-cursor" : "text-ink-gray-8 onb-select-cursor"
                  ]),
                  style: { "align-items": "center" }
                }, [
                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
                    class: "onb-step-left",
                    onClick: ($event) => $setup.handleAction(step)
                  }, [
                    step.is_complete ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_21, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", { innerHTML: $props.completeChecklistIcon }, null, 8, _hoisted_22)
                    ])) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_23, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", { innerHTML: $props.checklistIcon }, null, 8, _hoisted_24)
                    ])),
                    !step.is_skipped ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_25, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                        class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["text-base onb-step-text", step.is_complete ? "text-extra-muted" : ""])
                      }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__(step.action_label)), 3)
                    ])) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_26, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_27, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__(step.action_label)), 1)
                    ]))
                  ], 8, _hoisted_20),
                  !step.is_complete ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_28, [
                    !step.is_skipped ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_29, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_30, [
                        (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                          style: { "font-size": "12px", "vertical-align": "text-top", "margin-right": "0px" },
                          class: "text-ink-gray-7",
                          onClick: ($event) => $setup.markSkip(step)
                        }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Skip")), 9, _hoisted_31)
                      ])
                    ])) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true),
                    step.is_skipped ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_32, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_33, [
                        (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                          style: { "font-size": "12px", "vertical-align": "text-top", "margin-right": "0px" },
                          class: "text-ink-gray-7",
                          onClick: ($event) => $setup.markReset(step)
                        }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Reset")), 9, _hoisted_34)
                      ])
                    ])) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true)
                  ])) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true)
                ], 2)
  ...
  OnboardingPanel_default.render = render;
  OnboardingPanel_default.__file = "frappe/public/js/frappe/ui/user_onboarding/OnboardingPanel.vue";
  var OnboardingPanel_default2 = OnboardingPanel_default;

  // frappe/public/js/frappe/ui/user_onboarding/user_onboarding.bundle.js
  var UserOnboarding = class {
    ...
    init() {
      ...
      let me = this;
      const app = (0, vue_runtime_esm_bundler_exports.createApp)({
        components: { OnboardingPanel: OnboardingPanel_default2 },
        setup() {
          const showPanel = (0, vue_runtime_esm_bundler_exports.ref)(true);
          const steps = (0, vue_runtime_esm_bundler_exports.ref)(onboarding_checklist);
          return () => (0, vue_runtime_esm_bundler_exports.h)(OnboardingPanel_default2, {
  ...
  function addStyles() {
    if (document.getElementById("user-onboarding-styles"))
      return;
  ...
  var user_onboarding_bundle_default = UserOnboarding;
})();
/*! #__NO_SIDE_EFFECTS__ */
//# sourceMappingURL=user_onboarding.bundle.VNCOLZUN.js.map
