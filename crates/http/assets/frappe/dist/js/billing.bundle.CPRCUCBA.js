(() => {
  ...
  $(document).ready(function() {
    if (frappe.boot.is_fc_site && !!frappe.boot.setup_complete && !frappe.is_mobile() && frappe.user.has_role("System Manager")) {
      frappe.call({
...
//# sourceMappingURL=billing.bundle.CPRCUCBA.js.map
