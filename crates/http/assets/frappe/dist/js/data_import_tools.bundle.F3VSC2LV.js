(() => {
  ...
  frappe.data_import.DataExporter = class DataExporter {
    ...
    update_record_count_message() {
      ...
      if (!export_records || !count_method[export_records])
        return;
    ...
    setup_search_input() {
      ...
      if (this.dialog.$wrapper.find(".filters-search").length)
        return;
      $wrapper.before(`
      ...
      this.columns = this.preview_data.columns.map((col, i) => {
        ...
        if (col.skip_import) {
          ...
          return {
            ...
            name: frappe.utils.escape_html(col.header_title) || (df ? df.label : "Untitled Column"),
...
//# sourceMappingURL=data_import_tools.bundle.F3VSC2LV.js.map
