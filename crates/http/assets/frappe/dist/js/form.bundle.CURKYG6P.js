(() => {
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/address_list.html
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/contact_list.html
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/form_dashboard.html
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/form_footer.html
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/form_links.html
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/form_sidebar.html
  frappe.templates["form_sidebar"] = `<div class="flex justify-between sidebar-image-section sidebar-section hide">
	<div class="sidebar-image-wrapper">
		...
		<div class="sidebar-image-actions">
			<div class="sidebar-image-upload-hint">
				<svg class="es-icon icon-sm"><use href="#es-line-camera"></use></svg>
			</div>
...
<div class="sidebar-section sidebar-meta-details border-bottom">
	<div class="flex justify-between overflow-hidden">
		<div class="ellipsis">
			...
			<div class="form-details flex justify-between form-title-text"  data-copy="{%= frappe.utils.escape_html(frappe.utils.html2text(title)) %}">
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/print_layout.html
		...
		<div class="col-xs-5 text-right">
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu print-format-dropdown" style="max-height: 300px;
					...
					<li><a class="dropdown-item" href="/desk/Form/Print Settings">
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/report_links.html
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/set_sharing.html
  frappe.templates["set_sharing"] = `{% var standard_perms = [
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/timeline_message_box.html
...
`;
  ...
  // frappe-html:/Users/johannnefdt/RustroverProjects/open_frappe/apps/frappe/frappe/public/js/frappe/form/templates/users_in_sidebar.html
...
`;
  ...
  frappe.ui.form.make_quick_entry = (doctype, after_insert, init_callback, doc, force, skip_insert) => {
  ...
  frappe.ui.form.QuickEntryForm = class QuickEntryForm extends frappe.ui.Dialog {
    ...
    set_df_property(fieldname, prop, value) {
      var _a, _b;
      const field = (_a = this.fields_dict) == null ? void 0 : _a[fieldname];
      if (!field)
        return;
      field.df[prop] = value;
      (_b = field.refresh) == null ? void 0 : _b.call(field);
    }
    toggle_display(fnames, show) {
      this._apply_on_fields(fnames, (field) => {
        var _a;
        field.df.hidden = show ? 0 : 1;
        (_a = field.refresh) == null ? void 0 : _a.call(field);
      });
    }
    ...
    _apply_on_fields(fnames, fn) {
      ...
      names.forEach((fname) => {
        var _a;
        const field = (_a = this.fields_dict) == null ? void 0 : _a[fname];
        if (field)
          fn(field);
      });
    }
    ...
    make_html() {
      ...
      if (linked_doctypes.length === 0) {
        ...
        html = `
          ...
          frappe.utils.get_form_link(this.frm.doctype, this.frm.docname, true).bold()
        ])}
					</div>
					${linked_doctypes.map((doctype) => {
  ...
  frappe.ui.form.Toolbar = class Toolbar {
    ...
    refresh() {
      ...
      if (this.frm.meta.hide_toolbar) {
        ...
        if (this.frm.doc.__islocal) {
          ...
          const is_children_visible = this.page.menu.children().filter(function() {
        ...
        if (status !== this.current_status && status === "Amend") {
          ...
          frappe.xcall(
            ...
            if (is_amended) {
              ...
              btn.prop("disabled", true).wrap('<span style="display:inline-block"></span>').parent().attr("title", __("Already amended as {0}", [is_amended])).tooltip({ delay: { show: 400, hide: 100 }, trigger: "hover" });
              return;
            }
    ...
    show_jump_to_field_dialog() {
      ...
      let grid_form = grid_row == null ? void 0 : grid_row.grid_form;
      let fields = (grid_form ? grid_form.layout.fields_list : this.frm.fields).filter(visible_fields_filter).map((f) => ({ label: __(f.df.label), value: f.df.fieldname }));
        ...
        transitions.forEach((d) => {
          if (frappe.user_roles.includes(d.allowed) && has_approval_access(d)) {
            ...
            me.frm.page.add_action_item(__(d.action), function() {
              var _a, _b, _c;
              if ((_c = (_b = (_a = frappe.workflow) == null ? void 0 : _a.workflows) == null ? void 0 : _b[me.frm.doctype]) == null ? void 0 : _c.enable_action_confirmation) {
                frappe.confirm(
  ...
  frappe.ui.form.check_mandatory = function(frm) {
    ...
    if (lines.length) {
      frappe.msgprint({
        message: __("Please fill the following mandatory fields before saving:") + "<br><br><ul><li>" + lines.join("</li><li>") + "</li></ul>",
        indicator: "red",
  ...
  frappe.ui.form.update_calling_link = async (newdoc) => {
    ...
    if (!["Link", "Dynamic Link", "Table MultiSelect"].includes(df.fieldtype))
      return;
  ...
  frappe.ui.get_print_settings = function(pdf, callback, letter_head, pick_columns, has_filters = false, title = null) {
  ...
  frappe.ui.form.ScriptManager = class ScriptManager {
    ...
    get_handlers(event_name, doctype) {
      ...
      if ((_a = this.frm.cscript) == null ? void 0 : _a[event_name]) {
        handlers.old_style.push(event_name);
      }
      if ((_b = this.frm.cscript) == null ? void 0 : _b["custom_" + event_name]) {
...
${this.frm.doctype_layout.client_script}`;
  ...
  frappe.ui.form.AssignTo = class AssignTo {
    ...
    refresh() {
      ...
      let docinfo = (_b = (_a = this.frm).get_docinfo) == null ? void 0 : _b.call(_a);
  ...
  frappe.ui.form.Attachments = class Attachments {
    ...
    get_attachments() {
      var _a;
      return ((_a = this.frm.get_docinfo()) == null ? void 0 : _a.attachments) || [];
    }
  ...
  frappe.ui.form.Share = class Share {
    ...
    render_sidebar() {
      var _a;
      const shared = this.shared || ((_a = this.frm.get_docinfo()) == null ? void 0 : _a.shared) || [];
  ...
  function get_version_timeline_content(version_doc, frm) {
    ...
    ["added", "removed"].forEach(function(key) {
      if (data[key] && data[key].length) {
        ...
        if (parts2.length) {
          let messages = [];
          const countMap = parts2.reduce((acc, item) => {
  ...
  frappe.ui.form.Sidebar = class {
    ...
    make() {
      ...
      var sidebar_content = frappe.render_template("form_sidebar", {
        doctype: this.frm.doctype,
        frm: this.frm,
        can_write: frappe.model.can_write(this.frm.doctype, this.frm.docname) && !((_a = this.frm.fields_dict[this.frm.meta.image_field]) == null ? void 0 : _a.df.read_only),
        image_field: (_b = this.frm.meta.image_field) != null ? _b : false
      });
    ...
    refresh() {
      ...
      if (this.frm.doc.__islocal) {
        ...
        this.frm.tags && this.frm.tags.refresh((_a = this.frm.get_docinfo()) == null ? void 0 : _a.tags);
    ...
    setup_copy_event() {
      ...
      $(this.sidebar).find(".sidebar-meta-details " + classes.join(", ")).tooltip().on("click", (e) => {
    ...
    refresh_creation_modified() {
      this.sidebar.find(".modified-by").html(
        ...
        ) + " <br> " + (cint(frappe.boot.user.show_absolute_datetime_in_timeline) || cint(frappe.boot.sysdefaults.show_absolute_datetime_in_timeline) ? frappe.datetime.str_to_user(this.frm.doc.modified) : comment_when(this.frm.doc.modified))
      );
      this.sidebar.find(".created-by").html(
        ...
        ) + " <br> " + (cint(frappe.boot.user.show_absolute_datetime_in_timeline) || cint(frappe.boot.sysdefaults.show_absolute_datetime_in_timeline) ? frappe.datetime.str_to_user(this.frm.doc.creation) : comment_when(this.frm.doc.creation))
      );
    }
  ...
  var FormTimeline = class extends base_timeline_default {
    ...
    compose_mail(communication_doc = null, reply_all = false) {
      const args = {
        ...
        reply_all,
        sender: communication_doc == null ? void 0 : communication_doc.sender
      };
  ...
  frappe.ui.form.Footer = class FormFooter {
    ...
    refresh_comments_count() {
      var _a, _b;
      let count = (((_a = this.frm.get_docinfo()) == null ? void 0 : _a.comments) || []).length;
      (_b = this.wrapper.find(".comment-count")) == null ? void 0 : _b.html(count ? `(${count})` : "");
    }
  };
  ...
  frappe.ui.form.Form = class FrappeForm {
    ...
    configure_breadcrumb_width() {
      ...
      if (is_outside) {
        ...
        if (cint((_a = breadcrumb[0]) == null ? void 0 : _a.clientWidth) <= 30) {
          $(breadcrumb[0]).hide();
          if (cint((_b = breadcrumb[1]) == null ? void 0 : _b.clientWidth) <= 30) {
            $(breadcrumb[1]).hide();
    ...
    show_report_bug_link() {
      if (this.meta.beta) {
        this.add_web_link(
          "https://github.com/frappe/" + frappe.boot.module_app[frappe.scrub(this.meta.module)] + "/issues/new",
          __("Report bug")
        );
      }
    }
    ...
    rename_notify(dt, old, name) {
      ...
      if (!((_b = (_a = frappe._from_link) == null ? void 0 : _a.field_obj) == null ? void 0 : _b.frm)) {
    ...
    navigate_records(prev) {
      ...
      frappe.call({ method: "frappe.desk.form.utils.get_next", args, freeze: true }).then((r) => {
        if (r.message) {
  ...
  frappe.model.DocTypeController = class DocTypeController extends frappe.ui.form.Controller {
    ...
    set_naming_rule_description() {
      let naming_rule_description = {
        ...
        "Expression (old style)": "Format: <code>format:EXAMPLE-{MM}morewords{fieldname1}-{fieldname2}-{#####}</code> - Replace all braced words (fieldnames, date words (DD, MM, YY), series) with their value. Outside braces, any characters can be used.",
        Expression: "Format: <code>EXAMPLE-.#####</code> Series by prefix (separated by a dot)",
        Random: "",
        "By script": ""
      };
