(() => {
  ...
  var ListViewHeaderRow = class extends BaseComponent {
    ...
    render() {
      ...
      }, renderProps, generatorName: "dayHeaderContent", customGenerator: options.dayHeaderContent, defaultGenerator: renderInnerContent3, classNameGenerator: options.dayHeaderClassNames, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, (InnerContent) => y(
        "th",
  ...
  // frappe/public/js/calendar.bundle.js
  frappe.FullCalendar = Calendar;
  frappe.FullCalendar.Plugins = [index2, index, index3, index4];
})();
//# sourceMappingURL=calendar.bundle.CUFNYKMX.js.map
